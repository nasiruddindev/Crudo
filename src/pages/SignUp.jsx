      ...
      <Container>
        <div className="flex min-h-[80vh] rounded-3xl overflow-hidden shadow-2xl bg-white">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #1A1F1D 0%, #256A34 60%, #1A1F1D 100%)',
            }}
          >
            {/* Decorative circles */}
            <div className="absolute -top-16 -left-16 w-72 h-72 rounded-full bg-white/5"></div>
            <div className="absolute -bottom-20 -right-10 w-80 h-80 rounded-full bg-white/5"></div>
            ...
            <div className="relative z-10">
              <h1 className="text-4xl font-serif text-white font-semibold leading-snug mb-4">
                Join the <br />
                <span className="text-yellow-400">Crudo</span> Family
              </h1>
              <p className="text-white/70 font-karla text-base leading-relaxed">
                Discover premium products, exclusive deals, and a seamless shopping experience — all in one place.
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center px-8 md:px-16 py-12">
            ...
            <div className="mb-8">
              <Title text="Create Account" className="text-start" />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm text-offblack font-karla leading-relaxed">
                  I agree to the{' '}
              ...
              <Button text="CREATE ACCOUNT" className="w-full mt-2 justify-center text-center" />
